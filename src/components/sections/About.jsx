        ...
        <div className="about-grid">
          <div className="reveal">
            ...
            <div className="about-edu-block">
              ...
              <div className="about-edu-degree">B.S. Computer Science (spec. Machine Learning) · B.A. Economics (spec. Business)</div>
          ...
          <div className="reveal reveal-d2">
            <p className="about-bio">
              ...
              <strong>B.S. Computer Science and a B.A. in Economics</strong>.
            </p>
